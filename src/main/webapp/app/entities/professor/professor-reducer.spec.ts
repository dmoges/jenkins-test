...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './professor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFESSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFESSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROFESSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFESSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFESSOR actions', async () => {
      const arg = 42666;
