...
import { createEntity, getEntity, reset, updateEntity } from './speciality.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jenkinsTestApp.speciality.home.createOrEditLabel" data-cy="SpecialityCreateUpdateHeading">
            <Translate contentKey="jenkinsTestApp.speciality.home.createOrEditLabel">Create or edit a Speciality</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jenkinsTestApp.speciality.code')}
                id="speciality-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jenkinsTestApp.speciality.label')}
                id="speciality-label"
                name="label"
                data-cy="label"
                type="text"
