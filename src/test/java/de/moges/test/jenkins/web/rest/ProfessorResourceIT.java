...
class ProfessorResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "f[Pq%A@&M@.?";
    private static final String UPDATED_EMAIL = "Q8L@^k@.*a[3X;";
    ...
    void partialUpdateProfessorWithPatch() throws Exception {
        ...
        partialUpdatedProfessor.firstName(UPDATED_FIRST_NAME).hireDate(UPDATED_HIRE_DATE);
